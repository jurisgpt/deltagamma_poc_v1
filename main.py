...
def run_full_pipeline(node_file: str,
                      edge_file: str,
                      label_file: str,
                      graph_file: str,
                      node_ids_file: str,
...
def main():
    ...
    parser.add_argument('--task', choices=[
        'full_pipeline', 'build_graph', 'extract_embeddings', 'train_model'
    ...
    parser.add_argument('--node_ids_file', default='node_ids.csv',
                        help='Path for node ID mapping CSV')
    ...
    if args.task == 'full_pipeline':
        ...
        build_knowledge_graph(
            ...
            args.graph_file, args.node_ids_file
        )
        ...
        train_ml_model(
            args.embedding_file, args.label_file, args.model_file
        )
